                ...
                <div className="container mx-auto flex px-5 py-8 md:flex-row flex-col items-center">
                    ...
                    <div className="lg:flex-grow lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center ">
                        <p className="lg:max-w-[1350px] mb-8 leading-relaxed text-justify">
                            O restaurante Da terra, fundado em 12 de junho de 2012, projeto de um de seus fundadores, Clarissa Barcellos, visando dar continuidade ao trabalho de seus pais, Noé Felipe, dono do Restaurante Vida, e Jacira de Fátima, dona do Restaurante Lua. Ambos tinham como objetivo servir pratos que fossem saudáveis e que agradassem o público geral. <br></br>
                            Seguindo este ideal, Clarissa e Edson, seu marido e sócio, tiveram como objetivo fazer com que seu restaurante servisse um buffet saudável e saboroso que atendesse a toda família, desde crianças, até clientes mais seletivos.  <br></br>
                            O cuidado com os ingredientes, vai de hortaliças, até os componentes para pratos mais complexos, trabalhando com ingredientes integrais, vegetais frescos e selecionados, carne branca para opção de proteína animal, pratos veganos com opção de proteína vegetal, grãos e cereais.  <br></br>
